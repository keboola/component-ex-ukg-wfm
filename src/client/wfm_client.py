...
class WfmClient:
    ...
    def post_json(self, path: str, body: dict[str, Any], params: dict[str, Any] | None = None) -> Any:
        return self._call("POST", f"{self._api_base}{path}", json_body=body, params=params)

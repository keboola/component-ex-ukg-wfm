...
RESOURCE_REGISTRY: dict[str, ResourceDef] = {
    ...
    "information_access": _date_window("information_access", "information_access", "/commons/data/multi_read"),
    "timekeeping_punches": _date_window("timekeeping_punches", "timekeeping", "/timekeeping/punches/multi_read"),
    "timekeeping_timecards": _date_window("timekeeping_timecards", "timekeeping", "/timekeeping/timecard/multi_read"),
    ...
    "scheduling_schedules": _date_window("scheduling_schedules", "scheduling", "/scheduling/schedule/multi_read"),
    "scheduling_shifts": _date_window("scheduling_shifts", "scheduling", "/scheduling/shifts/multi_read"),
    ...
    "attendance_events": _date_window("attendance_events", "attendance", "/attendance/events/multi_read"),
